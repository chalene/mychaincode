...
chaincodeInvoke 0		# MSPorg1
chaincodeQuery 7 90
chaincodeInvoke 1		# MSPorg2
chaincodeQuery 5 80

echo "*******[Assert] Peer3 is not in endorser policy. i.e. Invoke on 3 will be failed."
chaincodeInvoke 3		# MSPorg3
chaincodeQuery 3 80
chaincodeInvoke 5		# MSPorg4
chaincodeQuery 1 80
chaincodeInvoke 7		# MSPorg5
chaincodeQuery 0 80


echo "*******[Assert] Peer2 is in endorser policy. i.e. Invoke on 2 will be succuessful."
installChaincode 2		# MSPorg2
chaincodeInvoke 2
chaincodeQuery 0 70
